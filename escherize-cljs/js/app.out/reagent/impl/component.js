...
if((i < len)){
var k = (ks[i]);
var G__13336 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13337 = (i + (1));
m = G__13336;
i = G__13337;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13341 = c;
var G__13341__$1 = (((G__13341 == null))?null:G__13341.prototype);
if((G__13341__$1 == null)){
return null;
} else {
return (G__13341__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13345 = c;
var G__13345__$1 = (((G__13345 == null))?null:G__13345.prototype);
if((G__13345__$1 == null)){
return null;
} else {
return (G__13345__$1["render"]);
}
})()));
});
...
return (function() { 
var G__13351__delegate = function (args){
var G__13349 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13349) : reagent.impl.component.as_element.call(null,G__13349));
};
...
while (G__13352__i < G__13352__a.length) {G__13352__a[G__13352__i] = arguments[G__13352__i + 0]; ++G__13352__i;}
  args = new cljs.core.IndexedSeq(G__13352__a,0);
} 
...
var args = cljs.core.seq(arglist__13353);
...
var _STAR_current_component_STAR_13356 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13356;
}});
...
var G__13364 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13364) {
...
return ((function (G__13364){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__13367 = reagent.impl.component.state_atom(c);
var G__13368 = f.call(c,c);
...
var or__6873__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__13370_13372 = (c["cljsRatom"]);
if((G__13370_13372 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13370_13372);
}
...
if(cljs.core.truth_((function (){var and__6861__auto__ = wrap;
...
var renders_13375 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13376 = cljs.core.first(cljs.core.vals(renders_13375));
if((cljs.core.count(renders_13375) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_13375))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_13376)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_13376], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6873__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6873__auto__)){
return or__6873__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6873__auto__ = render_fun;
if(cljs.core.truth_(or__6873__auto__)){
return or__6873__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6873__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6873__auto__)){
return or__6873__auto__;
} else {
...
var name__$1 = (function (){var G__13374 = name;
switch (G__13374) {
case "":
...
var elem = (function (){var G__13385 = (function (){var or__6873__auto__ = (function (){var G__13387 = c;
if((G__13387 == null)){
return null;
} else {
return (G__13387["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6873__auto__)){
return or__6873__auto__;
...
return (G__13385["_currentElement"]);
}
})();
var name = (function (){var G__13388 = elem;
var G__13388__$1 = (((G__13388 == null))?null:(G__13388["type"]));
if((G__13388__$1 == null)){
return null;
} else {
return (G__13388__$1["displayName"]);
}
})();
var path = (function (){var G__13389 = elem;
var G__13389__$1 = (((G__13389 == null))?null:(G__13389["_owner"]));
var G__13389__$2 = (((G__13389__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__13389__$1) : reagent.impl.component.component_path.call(null,G__13389__$1)));
if((G__13389__$2 == null)){
return null;
} else {
return [cljs.core.str(G__13389__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6873__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6873__auto__)){
return or__6873__auto__;
} else {
var G__13391 = c;
var G__13391__$1 = (((G__13391 == null))?null:G__13391.constructor);
if((G__13391__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13391__$1);
}
}
})();
