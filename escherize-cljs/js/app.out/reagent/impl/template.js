...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7479__auto__,writer__7480__auto__,opt__7481__auto__){
return cljs.core._write(writer__7480__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13421 = o;
(G__13421[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6861__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__6861__auto__){
var and__6861__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13430 = jsprops;
(G__13430["defaultValue"] = value);

(G__13430["onChange"] = ((function (G__13430,v,value,on_change){
return (function (p1__13427_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13427_SHARP_);
});})(G__13430,v,value,on_change))
);

(G__13430["ref"] = ((function (G__13430,v,value,on_change){
return (function (p1__13428_SHARP_){
return (this$["cljsInputElement"] = p1__13428_SHARP_);
});})(G__13430,v,value,on_change))
);
...
var vec__13437 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13437,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13437,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13437,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13442 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13442 == null)){
} else {
var key_13443 = temp__4661__auto___13442;
...
var G__13445 = (new reagent.impl.template.NativeWrapper());
(G__13445["name"] = c);
...
var G__13447 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13447) : reagent.impl.template.as_element.call(null,G__13447));
} else {
...
var len__7981__auto___13453 = arguments.length;
var i__7982__auto___13454 = (0);
while(true){
if((i__7982__auto___13454 < len__7981__auto___13453)){
args__7988__auto__.push((arguments[i__7982__auto___13454]));

var G__13455 = (i__7982__auto___13454 + (1));
i__7982__auto___13454 = G__13455;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7989__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13451){
var G__13452 = cljs.core.first(seq13451);
var seq13451__$1 = cljs.core.next(seq13451);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13452,seq13451__$1);
});
...
break;
default:
var G__13459 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13459;
continue;
...
var n__7791__auto___13462 = a.length;
var i_13463 = (0);
while(true){
if((i_13463 < n__7791__auto___13462)){
(a[i_13463] = reagent.impl.template.as_element((a[i_13463])));

var G__13464 = (i_13463 + (1));
i_13463 = G__13464;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7791__auto___13465 = a.length;
var i_13466 = (0);
while(true){
if((i_13466 < n__7791__auto___13465)){
var val_13467 = (a[i_13466]);
if((cljs.core.vector_QMARK_(val_13467)) && ((reagent.impl.template.key_from_vec(val_13467) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13466] = reagent.impl.template.as_element(val_13467));

var G__13468 = (i_13466 + (1));
i_13466 = G__13468;
continue;
} else {
}
...
var ctx = ({});
var vec__13472 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13472,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13472,(1),null);
...
var G__13476 = (cljs.core.count(argv) - first_child);
switch (G__13476) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13476){
