...
var or__6873__auto__ = reagent.dom.server.imported = require("react-dom/server");
...
var _STAR_non_reactive_STAR_13481 = reagent.impl.util._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_13481;
}});
/**
...
var _STAR_non_reactive_STAR_13483 = reagent.impl.util._STAR_non_reactive_STAR_;
reagent.impl.util._STAR_non_reactive_STAR_ = true;

try{return (reagent.dom.server.module()["renderToStaticMarkup"])(reagent.impl.template.as_element(component));
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_13483;
}});
